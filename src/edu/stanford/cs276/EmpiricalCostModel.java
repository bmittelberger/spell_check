...
public class EmpiricalCostModel implements EditCostModel {
	...
	private static Map<String, Integer> uni_letter_counts = new HashMap<String, Integer>();
	private static Map<Pair<String, String>, Integer> bi_letter_counts = new HashMap<Pair<String, String>, Integer>();
	private static Map<Pair<String, String>, Integer> sub_counts = new HashMap<Pair<String, String>, Integer>();
	private static Map<Pair<String, String>, Integer> insert_counts = new HashMap<Pair<String, String>, Integer>();
	private static Map<Pair<String, String>, Integer> delete_counts = new HashMap<Pair<String, String>, Integer>();
	private static Map<Pair<String, String>, Integer> transp_counts = new HashMap<Pair<String, String>, Integer>();
